 ...
 * @implNote
 * @implNote Stringbuffer ensureCapacity() method:
 * @implNote -> The ensureCapacity() method of StringBuffer class ensure that
 *           the given capacity is the minimum to the current capacity. If it is
 *           greater than the current capacity, it increase the capacity by
...
public class Ensure_Capacity_Method
{
	public static void main(String[] args)
	{
		...
		name.append("Java is my favourite language");
		System.out.println(name.capacity()); // now(16*2)+2 = 34
		name.ensureCapacity(10);
		System.out.println(name.capacity()); // No change now 34
		name.ensureCapacity(50); // now (34*2)+2 = 70
