 ...
 * @implNote
 * @implNote StringBuffer replace() method:
 * @implNote -> The replace method replaces the given string from the specified
...
public class Replace_Method
{
	public static void main(String[] args)
	{
		...
		StringBuffer fullName = name.replace(6, 6, "Sanjay");
