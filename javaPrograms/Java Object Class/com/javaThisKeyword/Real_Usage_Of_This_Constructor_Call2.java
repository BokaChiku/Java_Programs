 ...
 */
public class Real_Usage_Of_This_Constructor_Call2
{
	int rollNo;
	String name;
	float fee;

	Real_Usage_Of_This_Constructor_Call2(int rollNo, String name)
	{
		this.rollNo = rollNo;
		this.name = name;
	}

	Real_Usage_Of_This_Constructor_Call2(int rollNo, String name, float fee)
	{
		this.fee = fee;
		this(rollNo, name); // Reusing constructor
		// Above line give C.T Error
	}
	...
	{
		Real_Usage_Of_This_Constructor_Call2 Obj = new Real_Usage_Of_This_Constructor_Call2(10, "Kunal", 23.36f);
		Obj.display();
