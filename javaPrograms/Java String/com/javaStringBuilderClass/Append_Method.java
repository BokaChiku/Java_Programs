 ...
 * @implNote
 * @implNote The StringBuilder append() method:
 * @implNote -> It concatenates the given argument with this string.
 */
public class Append_Method
{
	public static void main(String[] args)
	{
		...
		name.append(" Chavan");
		System.out.println(name); // Kunal Chavan
		String nameTwo = new StringBuilder().append("Vishal").append(" Chavan").toString();
		System.out.println(nameTwo); // Vishal Chavan
